 ...
 * @since 0.10.2
 */
public class InvalidElementException extends AttributeException {
   ...
   */
  public InvalidElementException(String name) {
    this(name, null);
  }
   ...
   */
  public InvalidElementException(String name, @Nullable Throwable cause) {
