...
public final class PSResource {
  ...
  public PSResource(PSResourceType type, String name) {
    ...
    this._includeErrorContent = this._type == PSResourceType.SERVICE;
  }
  ...
  private String toURLString(PSSession session, boolean includePOSTParameters) {
    ...
    if (this._type != PSResourceType.SERVICE) {
      url.append(query != null? '&' : '?').append("xformat=xml");
    }

    // When not using the "application/x-www-form-urlencoded"
    boolean firstParameter = query == null && this._type == PSResourceType.SERVICE;
  ...
  public static final class Builder {
    ...
    public Builder(PSResourceType type, String name) {
      ...
      this._includeError = type == PSResourceType.SERVICE;
    }
