...
import org.pageseeder.bridge.net.PSConnection.Method;
...
public final class PSConnector {
   ...
   */
  public PSConnection connect(Method type) throws IOException {
   ...
   */
  public PSResponseInfo get() throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo get(XMLWriter xml) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo get(DefaultHandler handler) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo get(XMLWriter xml, Templates templates) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo get(XMLWriter xml, Templates templates, Map<String, String> parameters) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo post() throws APIException {
    return handle(Method.POST, (DefaultHandler)null);
  }
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo post(DefaultHandler handler) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo post(XMLWriter xml) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo post(XMLWriter xml, Templates templates) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo post(XMLWriter xml, Templates templates, Map<String, String> parameters) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo put(DefaultHandler handler) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo put(XMLWriter xml) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo delete(DefaultHandler handler) throws APIException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo delete(XMLWriter xml) throws APIException {
   ...
   */
  private PSResponseInfo handle(Method method, DefaultHandler handler) throws APIException {
    PSResource resource = this._resource.build();
    PSResponseInfo response = new PSResponseInfo();
    try {
      PSConnection connection = PSConnection.connect(resource, method, this._user);
   ...
   *         <code>false</code> otherwise.
   */
  private PSResponseInfo copy(Method method, XMLWriter xml) throws APIException {
    PSResource resource = this._resource.build();
    PSResponseInfo response = new PSResponseInfo();
    try {
      PSConnection connection = PSConnection.connect(resource, method, this._user);
   ...
   *         <code>false</code> otherwise.
   */
  private PSResponseInfo transform(Method method, XMLWriter xml, Templates templates, Map<String, String> parameters) throws APIException {
    PSResource resource = this._resource.build();
    PSResponseInfo response = new PSResponseInfo();
    try {
      PSConnection connection = PSConnection.connect(resource, method, this._user);
