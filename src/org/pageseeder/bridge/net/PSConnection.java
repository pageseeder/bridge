...
public final class PSConnection {
   ...
   */
  private PSConnection(HttpURLConnection connection, PSResource resource, Method method, PSSession user, String boundary) {
   ...
   */
  public void process(PSResponseInfo response, DefaultHandler handler) throws IOException {
    try {
   ...
   *         <code>false</code> otherwise.
   */
  public void process(PSResponseInfo response, XMLWriter xml) throws IOException {
    try {
      // Retrieve the content of the response
      int status = this._connection.getResponseCode();
      response.setCodeAndStatus(status);
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo process(PSResponseInfo response, XMLWriter xml, Templates templates) throws IOException {
   ...
   *         <code>false</code> otherwise.
   */
  public PSResponseInfo process(PSResponseInfo response, XMLWriter xml, Templates templates, Map<String, String> parameters) throws IOException {
    try {
      // Retrieve the content of the response
      int status = this._connection.getResponseCode();
      response.setCodeAndStatus(status);
   ...
   */
  protected static PSConnection connect(PSResource resource, Method type, PSSession user) throws IOException {
   ...
   */
  private static void handleXML(HttpURLConnection connection, PSResponseInfo response, DefaultHandler handler, boolean duplex)
      throws IOException {
   ...
   * @throws IOException If an error occurs while writing the XML.
   */
  private static boolean transformXML(HttpURLConnection connection, PSResponseInfo response, XMLWriter xml,
...
//  }
   ...
   */
  private static void parseError(HttpURLConnection connection, PSResponseInfo info) throws IOException {
  ...
  private static class HandlerDispatcher extends DefaultHandler {
    ...
    private final PSResponseInfo response;
     ...
     */
    public HandlerDispatcher(XMLReader reader, PSResponseInfo response, DefaultHandler handler) {
      this.reader = reader;
  ...
  private static class PSErrorHandler extends DefaultHandler {
    ...
    private PSResponseInfo response;

    /** State: Within "message" element. */
    private boolean isMessage = false;

    public PSErrorHandler(PSResponseInfo response) {
      this.response = response;
    }
     ...
     */
    public static void parseError(InputSource source, PSResponseInfo response) throws IOException {
      try {
        SAXParserFactory factory = SAXParserFactory.newInstance();
        factory.setValidating(false);
